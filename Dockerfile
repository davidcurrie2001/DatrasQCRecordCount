...
# docker build -t  mi/datrasrecordcount:test .
#
...
# docker run --name datrasrecordcount --rm -d -v $PWD/DatrasData:/srv/shiny-server/data -p 3850:3838 mi/datrasrecordcount:test
#
